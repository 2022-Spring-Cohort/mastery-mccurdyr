...
public class Populator implements CommandLineRunner {
    ...
    public Populator(TopicRepository topicRepo, PostRepository postRepo, HashtagRepository hashRepo) {
...
//TODO add authors and add them to single-post-template
